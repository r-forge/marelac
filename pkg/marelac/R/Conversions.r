...
{
Waals <- data.frame(
a=c(  1.363,3.640,11.77,1.505,19.7483,6.579,13.04,12.18,
...
b=c( 0.03219,0.04267,0.07685,0.03985,0.1281, 0.05622,0.09213,0.08407,
  0.1286, 0.05264,0.04278,0.06702,0.146,  0.08445,0.03049,0.0237,
  0.02661,0.04431,0.04081,0.04287,0.01696,0.03978,0.03707,0.01709,
  0.02789,0.03913,0.04424,0.04415,0.03183,0.05156,0.05786,0.05571,
  0.05636,0.05105))
rownames(Waals)<-c("Ar","CO2","CS2","CO","CCl4","Cl2","C2H6S","C2H5OH",
...
if (a==0 & b==0) V=  x*R* TK / P else
{
V <- NULL
for (TT in TK) {for (PP in P) {for (xx in x)
