...
## -----------------------------------------------------------------------------
  ...
  .marelac$WCDat <- matrix(nc=1, data=c(34.7,35.2,24.5,23.6,36.0,34.5,43.8))
...
# KS -> ThP
  ...
  # I have to use cbind() or c(); cbind with a NULL or N2 does not work so I
  # have to check if it has a value  - not very nice coding
