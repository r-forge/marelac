...
cond2sal <- function (R=1, T=25, P=1.013253, hydroP=max(0,P-1.013253))
{
#=========================================================================
...
#=========================================================================
    ...
    P   <- hydroP*10    # uses decibar in calculations, hydrostatic pressure
...
sal2cond <- function(T=25, S=35, P=1.013253, hydroP=max(0,P-1.013253))
#=========================================================================
# using UNESCO 1983 polynomial.
#
# REFERENCES:
...
{
   fun <- function(x)
     cond2sal(x, T=T, hydroP=hydroP) - S
